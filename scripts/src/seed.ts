...
async function seed() {
  ...
  if (afterCount.length === 0) {
    const programs = [
      ...
      { schoolName: "University of Zimbabwe", programName: "BSc Computer Information Systems", faculty: "Commerce", requiredSubjects: ["Mathematics", "Accounting"], minimumPoints: 10, minOLevelPasses: 5, minALevelPasses: 2, duration: "4 years", description: "Business-oriented IT degree combining computing with commerce", careerCategory: "Technology" },
      ...
      { schoolName: "University of Zimbabwe", programName: "LLB Bachelor of Laws", faculty: "Law", requiredSubjects: ["Literature in English", "History"], minimumPoints: 10, minOLevelPasses: 5, minALevelPasses: 2, duration: "4 years", description: "Professional legal degree covering Zimbabwean and international law", careerCategory: "Law" },
      { schoolName: "University of Zimbabwe", programName: "BCom Accounting", faculty: "Commerce", requiredSubjects: ["Mathematics", "Accounting"], minimumPoints: 8, minOLevelPasses: 5, minALevelPasses: 2, duration: "4 years", description: "Professional accounting degree with ICAZ and ACCA exemptions", careerCategory: "Business & Finance" },
      ...
      { schoolName: "University of Zimbabwe", programName: "BSc Psychology", faculty: "Social Sciences", requiredSubjects: ["Biology", "Literature in English"], minimumPoints: 8, minOLevelPasses: 5, minALevelPasses: 2, duration: "3 years", description: "Study of human behaviour, mental health and counselling", careerCategory: "Social Sciences" },
      { schoolName: "University of Zimbabwe", programName: "BA Journalism & Media Studies", faculty: "Arts", requiredSubjects: ["Literature in English", "History"], minimumPoints: 8, minOLevelPasses: 5, minALevelPasses: 2, duration: "3 years", description: "Media production, journalism ethics and communication theory", careerCategory: "Media & Communication" },
      ...
      // Africa University
      { schoolName: "Africa University", programName: "BBA Business Administration", faculty: "Business", requiredSubjects: ["Mathematics", "Accounting"], minimumPoints: 7, minOLevelPasses: 5, minALevelPasses: 2, duration: "4 years", description: "International business management and entrepreneurship", careerCategory: "Business & Finance" },
      ...
      { schoolName: "Africa University", programName: "BA Peace & Governance", faculty: "Humanities", requiredSubjects: ["History", "Literature in English"], minimumPoints: 7, minOLevelPasses: 5, minALevelPasses: 2, duration: "4 years", description: "Political science, diplomacy and conflict resolution", careerCategory: "Social Sciences" },
      // Great Zimbabwe University
      { schoolName: "Great Zimbabwe University", programName: "BEd Secondary Education (Commerce)", faculty: "Education", requiredSubjects: ["Accounting", "Commerce"], minimumPoints: 7, minOLevelPasses: 5, minALevelPasses: 2, duration: "4 years", description: "Train as a commerce and accounts teacher", careerCategory: "Education" },
      { schoolName: "Great Zimbabwe University", programName: "BCom Tourism & Hospitality", faculty: "Commerce", requiredSubjects: ["Geography", "Literature in English"], minimumPoints: 7, minOLevelPasses: 5, minALevelPasses: 2, duration: "4 years", description: "Tourism management and hospitality in Zimbabwe's rich heritage context", careerCategory: "Business & Finance" },
