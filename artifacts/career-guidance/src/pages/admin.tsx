...
import { ShieldAlert, Plus, Upload, Trash2, Edit } from "lucide-react";
...
export default function AdminPage() {
  ...
  const form = useForm<z.infer<typeof programSchema>>({
    ...
    defaultValues: {
      ...
      minimumPoints: null, duration: "", description: "", careerCategory: ""
    }
  });
      ...
      <div className="max-w-6xl mx-auto">
        ...
        <Tabs defaultValue="programs" className="w-full">
          <TabsList className="mb-8 bg-white border shadow-sm">
            <TabsTrigger value="programs" className="data-[state=active]:bg-primary/10 data-[state=active]:text-primary">Programs List</TabsTrigger>
              ...
              <Table>
                ...
                <TableBody>
                  {programs?.length ? programs.map((p) => (
                    ...
                    <TableRow>
                      <TableCell colSpan={5} className="text-center text-muted-foreground h-32">No programs available. Add some data.</TableCell>
                    </TableRow>
                  )}
                </TableBody>
              </Table>
