...
import { Compass, BarChart2, MessageSquare, Star, Menu, X, User, LogOut, Settings } from "lucide-react";
...
export function Layout({ children }: { children: React.ReactNode }) {
  ...
  if (user?.role === 'admin') {
    navLinks.push({ href: "/admin", label: "Admin", icon: <Settings className="w-4 h-4 mr-2" /> });
  }
